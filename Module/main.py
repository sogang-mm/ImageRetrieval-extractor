...
import torch
import os
from Module.mobilenet_avg_part2.model import MobileNet_AVG_PART2
...
class Extractor:
    def __init__(self):
        ...
        self.result = None
        self.model = MobileNet_AVG_PART2()
        self.model.load_state_dict(torch.load('/workspace/Module/mobilenet_avg_part2/mobilenet_avg.pth')['model_state_dict'],strict=False)
        self.model.cpu()
        self.model.eval()
