...
from RetrievalExtractor import config

os.environ.setdefault('DJANGO_SETTINGS_MODULE', 'RetrievalExtractor.settings')

app = Celery('RetrievalExtractor')
...
app.conf.beat_schedule = {
    'delete-old-database': {
        'task': 'Extractor.beats.delete_old_database',
        'schedule': crontab(
